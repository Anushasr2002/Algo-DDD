...
namespace AlgoDDD.Strategy.Tests
{
    public class StrategyEngineTests
    {
        ...
        public static IEnumerable<TestCaseData> SmaTestCases()
        {
            ...
            yield return new TestCaseData(PriceBarFactory.CreateSidewaysTrend(), SignalType.Hold).SetName("SMA_SidewaysTrend_ShouldReturnHold");
        }
        ...
        public static IEnumerable<TestCaseData> MeanReversionTestCases()
        {
            ...
            yield return new TestCaseData(PriceBarFactory.CreateSidewaysTrend(), SignalType.Hold).SetName("MR_SidewaysTrend_ShouldReturnHold");
        }
        ...
        public static IEnumerable<TestCaseData> MomentumTestCases()
        {
            ...
            yield return new TestCaseData(PriceBarFactory.CreateSidewaysTrend(), SignalType.Hold).SetName("Momentum_SidewaysTrend_ShouldReturnHold");
        }
    }
