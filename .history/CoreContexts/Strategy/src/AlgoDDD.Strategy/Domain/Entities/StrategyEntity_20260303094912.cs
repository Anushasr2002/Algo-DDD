...
namespace AlgoDDD.Strategy.Domain.Entities
{
    public class StrategyEntity
    {
        ...
        public string Name { get; set; } = string.Empty;
         public string Description { get; set; } = string.Empty; public string TimeFrame { get; set; } = string.Empty; public int MaxPositionSize { get; set; } public decimal StopLoss { get; set; } public decimal TakeProfit { get; set; }}
