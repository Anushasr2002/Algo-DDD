...
namespace AlgoDDD.Strategy.Infrastructure.Repository
{
    public class StrategyRepository : IStrategyRepository
    {
        ...
        {
            // You need to define EvaluationResultDataModel first
            var dataModel = new EvaluationResultDataModel
            {
                Id = Guid.NewGuid(), // or result.Id if EvaluationResult has an Id
            ...
            // Make sure your DbContext has EvaluationResults DbSet
