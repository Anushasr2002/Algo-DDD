...
namespace AlgoDDD.Strategy.Domain.Services
{
    ...
    public class StrategyEngine
    {
        ...
        /// <summary>
        /// Initializes a new instance of the StrategyEngine with a market data provider.
        /// </summary>
        /// <param name="marketDataProvider">Provider for historical market data bars.</param>
        ...
        public async Task<List<Signal>> ExecuteStrategyAsync(StrategyEntity strategyEntity)
        {
            ...
            foreach (var symbol in strategyEntity.Symbols)
            {
                ...
                switch (strategyEntity.StrategyType)
                {
                    ...
                    /// - Computes mean and standard deviation of prices.
                    ...
                    /// - Computes 20-period SMA and standard deviation.
